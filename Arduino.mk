...
ifeq ("$(RP2040_FLASHSIZE)", "2MB")
RP2040_FLASHSIZE:=2097152
else ifeq ("$(RP2040_FLASHSIZE)", "4MB")
RP2040_FLASHSIZE:=4194304
else ifeq ("$(RP2040_FLASHSIZE)", "8MB")
RP2040_FLASHSIZE:=8388608
endif
RP2040_FREQ?=133
RP2040_OPT?=Small
RP2040_RTTI?=Disabled
RP2040_STACKPROTECT?=Disabled
RP2040_DBGPORT?=Disabled
RP2040_EXCEPTIONS?=Disabled
RP2040_DBGLVL?=None
RP2040_USBSTACK?=picosdk
RP2040_IPBTSTACK?=ipv4only
RP2040_UPLOADMETHOD?=default
RP2040_OPTIONS=flash=$(RP2040_FLASHSIZE)_0,freq=$(RP2040_FREQ),opt=$(RP2040_OPT),rtti=$(RP2040_RTTI),stackprotect=$(RP2040_STACKPROTECT),exceptions=$(RP2040_EXCEPTIONS),dbgport=$(RP2040_DBGPORT),dbglvl=$(RP2040_DBGLVL),usbstack=$(RP2040_USBSTACK),ipbtstack=$(RP2040_IPBTSTACK),uploadmethod=$(RP2040_UPLOADMETHOD)
...
ifeq ($(UNAME_S),Darwin)
ESP32_UPLOAD?=$(ARDUINO_PACKAGES)/esp32/tools/esptool_py/$(ESP32_UPLOAD_VERSION)/esptool
else
